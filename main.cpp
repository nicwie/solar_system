...
int main(void) {
    ...
    Earth earth("../models/earth(1).glb", "../images/2k_earth_daymap.jpg", "../images/2k_earth_nightmap.jpg", "../images/2k_earth_clouds.jpg", "../images/earthspec1k.jpg", 4.01f, AU * 1.0f, 10.0f, 10.0f, 23.5f, 0.98f,
